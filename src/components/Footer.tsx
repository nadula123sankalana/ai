...
const footerLinks = {
  ...
  Channels: ["Meta", "TikTok", "YouTube", "Instagram", "Snapchat", "OTT & CTV", "Amazon"],
  Company: ["About us", "Pricing", "Case studies", "Blog", "Careers", "Contact", "Affiliate"],
};
      ...
      <div className="container relative">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-6 md:gap-8">
          <div className="col-span-2">
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed text-white/65">
              {t(
                "World-class video production, powered by AI and built for the teams making the next decade of great marketing.",
              )}
            </p>
            ...
            <div className="mt-7 rounded-2xl border border-white/10 bg-white/[0.03] p-4 backdrop-blur">
              <div className="text-[11px] font-bold uppercase tracking-wider text-white/60">{t("Get creative tips")}</div>
              <p className="mt-1 text-sm text-white/80">{t("Weekly playbook. No spam. Unsubscribe anytime.")}</p>
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-8 md:flex-row md:items-center">
          <p className="text-xs text-white/55">
            {t(`© ${new Date().getFullYear()} Catalyst AI. All rights reserved. · Made for marketers who ship.`)}
          </p>
