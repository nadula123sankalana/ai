        ...
        >
          <div className="max-w-xl">
            ...
            <h2 className="mt-5 font-heading text-3xl font-800 leading-tight tracking-tight text-foreground md:text-5xl">
              {t("Ideas, insights & creative tips")}
              <span className="block text-gradient">{t("from the Catalyst team.")}</span>
            </h2>
          </div>
          <a
            href="#"
          ...
          >
            {t("View all posts")} <ArrowRight className="h-4 w-4" />
          </a>
        </motion.div>
                ...
                <div className="mt-auto flex items-center justify-between pt-6">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-muted-foreground">{t(p.date)}</div>
                    </div>
                  </div>
